...
function JobView() {
  ...
  >
    ...
    <CardActions>
            {sessionStorage.getItem("account")?<Button onClick={handleDialogOpen} variant="contained" size="medium">
              Apply
            </Button>:<Button onClick={() => window.open("/login")} variant="contained" size="medium">
              Login to Apply
            </Button> }
          </CardActions>
  </Card>
