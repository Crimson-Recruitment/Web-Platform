          ...
          <Grid item lg={9} xl={7}>
            <Card>
              ...
              <CardContent className="text-black p-4">
                <div className="mb-5">
                  <Typography variant="h5" className="fw-normal mb-1">
                    About
                  </Typography>
                  <div className="p-4" style={{ backgroundColor: "#f8f9fa" }}>
                    <Typography variant="body2" className="font-italic mb-1">
                      Web Developer
                    </Typography>
                    <Typography variant="body2" className="font-italic mb-1">
                      Lives in New York
                    </Typography>
                    <Typography variant="body2" className="font-italic mb-0">
                      Photographer
                    </Typography>
                  </div>
                </div>
                <div className="d-flex justify-content-between align-items-center mb-4">
                  <Typography variant="h5" className="fw-normal mb-0">
                    Recent photos
                  </Typography>
