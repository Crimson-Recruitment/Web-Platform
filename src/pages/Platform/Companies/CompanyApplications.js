...
function CompanyApplications() {
  return (
    <CompanySideBar>
      ...
      <div
        id="drawer-swipe"
        class="fixed  h-[60vh] z-40 w-full overflow-y-auto bg-white border-t border-gray-200 rounded-t-lg dark:border-gray-700 dark:bg-gray-800 transition-transform bottom-0 left-0 right-0 translate-y-full bottom-[60px]"
        tabindex="-1"
