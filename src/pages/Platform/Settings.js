            ...
            <div className="row align-items-center">
              ...
              <div className="col-auto">
                <div className="custom-control custom-switch">
                  <input type="checkbox" className="custom-control-input" id="alert1" />
        ...
        <div className="list-group mb-5 shadow">
          <div className="list-group-item">
            <div className="row align-items-center">
              ...
              <div className="col-auto">
                <div className="custom-control custom-switch">
                  <input type="checkbox" className="custom-control-input" id="alert3" />
                  <span className="custom-control-label"></span>
                </div>
              </div>
            </div>
          ...
          <div className="list-group-item">
            <div className="row align-items-center">
              ...
              <div className="col-auto">
                <div className="custom-control custom-switch">
                  <input type="checkbox" className="custom-control-input" id="alert4" />
                  <span className="custom-control-label"></span>
                </div>
              </div>
            </div>
