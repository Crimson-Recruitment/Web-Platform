...
function ZoomConnectSuccess() {
    ...
    useEffect(() => {
        ...
        (async () => {
            let data = await getCode(sessionStorage.getItem("companyToken")!,searchParams.get("code")!);
              ...
              >
                <div>
                  ...
                  <Typography variant="body1">
                    ...
                    <Link href="http://localhost:3000/company-home" sx={{color:"#8B0000"}} underline="hover" fontWeight="bold">
                      here
                    </Link>
                    .
                  </Typography>
      ...
      >
        <div>
          ...
          <Typography variant="body1" color="text.primary">
            ...
            <Link href="http://localhost:3000/company-home" color="primary" underline="hover" fontWeight="bold">
              here
            </Link>
            .
          </Typography>
