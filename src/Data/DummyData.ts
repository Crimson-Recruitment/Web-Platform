...
const jobs: JobsModel[] = [
  ...
  },
  {
    ...
    jobDescription: 'Exciting opportunity for a digital marketing specialist...',
    companyOverview: ['Leading marketing agency', 'Collaborative team environment'],
    requirements: ['Bachelor\'s degree in Marketing', '3+ years of digital marketing experience'],
  ...
  },
  {
    ...
    companyOverview: ['Global financial institution', 'Diverse and inclusive workplace'],
  ...
  },
  {
    ...
    companyOverview: ['Fast-growing tech startup', 'Dynamic and inclusive culture'],
    requirements: ['Bachelor\'s degree in Human Resources', '2+ years of HR experience'],
  ...
  },
  {
    ...
    requirements: ['Bachelor\'s degree in Mechanical Engineering', '5+ years of engineering experience'],
  ...
  },
  {
    ...
    companyOverview: ['Leading healthcare provider', 'Committed to patient care'],
...
const applications: ApplicationsModel[] = [
  ...
  },
  {
    ...
    coverLetter: 'I have successfully executed marketing campaigns in the past...',
  },
];
