...
const ApplicationCard = (props: { applicant: any; jobName: any; timeOfApplication: any; applicationStatus: any;resumePath:string }) => {
  const {applicant, jobName, timeOfApplication, applicationStatus, resumePath} = props;
  ...
  return (
    <div style={{ position: 'relative', marginBottom: isMenuOpen ? '200px' : '0' }}>
      <Card
      ...
      <Fade in={isMenuOpen} timeout={300}>
        ...
        >
          ...
          <MenuItem onClick={handleChatWithRecruiter}>Chat with Recruiter</MenuItem>
        </Paper>
      </Fade>
    </div>
  );
